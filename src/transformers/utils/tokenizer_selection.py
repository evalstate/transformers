...
class CorpusAnalyzer:
    ...
    @staticmethod
    def _detect_language_hint(char_counter: Counter) -> str | None:
...
def suggest_and_train_tokenizer(text_iterator: Iterator[list[str]], vocab_size: int | None = None, **kwargs):
    """
