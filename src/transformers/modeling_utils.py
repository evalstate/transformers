...
class PreTrainedModel(nn.Module, EmbeddingAccessMixin, ModuleUtilsMixin, PushToHubMixin, PeftAdapterMixin):
    ...
    def _init_weights(self, module):
        ...
        if isinstance(module, (nn.Linear, nn.Conv1d, nn.Conv2d, nn.Conv3d, nn.ConvTranspose1d, nn.ConvTranspose2d)):
            if getattr(module, "weight", None) is not None and module.weight.is_floating_point():
    ...
    def save_pretrained(
        ...
        **kwargs,
        ...
        # Skip if saving PEFT adapters or if the quantizer already provided the state_dict in the correct serialization format.
    ...
    def from_pretrained(
        ...
        **kwargs,
        ...
        custom_hf_quantizer = model_kwargs.pop("hf_quantizer", None)
        hf_quantizer, config, device_map = get_hf_quantizer(
            config, quantization_config, device_map, weights_only, user_agent, custom_hf_quantizer
        )
