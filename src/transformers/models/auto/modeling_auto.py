...
MODEL_MAPPING_NAMES = OrderedDict(
    [
        ...
        ("audiovisualflamingo", "AudioVisualFlamingoForConditionalGeneration"),
        ...
        ("kimi2_6", "Kimi2_6Model"),
        ("kimi2_6_vision", "Kimi2_6VisionModel"),
        ...
        ("penguinvl", "PenguinVLModel"),
        ("penguinvl_vision", "PenguinVLVisionModel"),
...
MODEL_FOR_CAUSAL_LM_MAPPING_NAMES = OrderedDict(
    [
        ...
        ("rwkv", "RwkvForCausalLM"),
        ("sarvam_mla", "DeepseekV3ForCausalLM"),
...
MODEL_FOR_IMAGE_TEXT_TO_TEXT_MAPPING_NAMES = OrderedDict(
    [
        ...
        ("janus", "JanusForConditionalGeneration"),
        ("kimi2_6", "Kimi2_6ForConditionalGeneration"),
        ...
        ("paligemma", "PaliGemmaForConditionalGeneration"),
        ("penguinvl", "PenguinVLForConditionalGeneration"),
...
MODEL_FOR_SEQUENCE_CLASSIFICATION_MAPPING_NAMES = OrderedDict(
    [
        ...
        ("sarvam_mla", "DeepseekV3ForSequenceClassification"),
...
MODEL_FOR_TOKEN_CLASSIFICATION_MAPPING_NAMES = OrderedDict(
    [
        ...
        ("sarvam_mla", "DeepseekV3ForTokenClassification"),
