...
class VisionEncoderDecoderModel(PreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        **kwargs,
        ...
        kwargs_decoder.setdefault(
            "output_attentions", kwargs_encoder.get("output_attentions", self.config.output_attentions)
        )
        kwargs_decoder.setdefault(
            "output_hidden_states", kwargs_encoder.get("output_hidden_states", self.config.output_hidden_states)
        )
