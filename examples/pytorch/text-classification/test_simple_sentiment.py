...
try:
    from run_simple_sentiment import compute_metrics, preprocess_function
except ImportError:
...
class TestSimpleSentiment(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.model = AutoModelForSequenceClassification.from_pretrained(cls.model_name, num_labels=2)
    ...
    def test_preprocess_function(self):
        ...
        examples = {"text": ["This is a positive review.", "This is a negative review."]}
